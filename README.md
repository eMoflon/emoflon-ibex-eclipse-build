...
| Name                     | OS          | eMoflon installed  |  Splash image      | Pattern matcher | Additional packages |
|--------------------------|-------------|--------------------|--------------------|-----------------|---------------------|
| Eclipse eMoflon user     | Linux       | :heavy_check_mark: | :heavy_check_mark: | HiPE            | :heavy_check_mark:  |
| Eclipse eMoflon dev      | Linux       |                    | :heavy_check_mark: | HiPE, *)        | :heavy_check_mark:  |
...
| Eclipse eMoflon user     | Windows     | :heavy_check_mark: | :heavy_check_mark: | HiPE            | :heavy_check_mark:  |
| Eclipse eMoflon dev      | Windows     |                    | :heavy_check_mark: | HiPE, *)        | :heavy_check_mark:  |
| Eclipse eMoflon dev HiPE | Windows     |                    | :heavy_check_mark: | *)              | :heavy_check_mark:  |
| Eclipse eMoflon user     | macOS       | :heavy_check_mark: | :heavy_check_mark: | HiPE            | :heavy_check_mark:  |
| Eclipse eMoflon dev      | macOS       |                    | :heavy_check_mark: | HiPE, *)        | :heavy_check_mark:  |
| Eclipse eMoflon dev HiPE | macOS       |                    | :heavy_check_mark: | *)              | :heavy_check_mark:  |
| Eclipse eMoflon user     | macOS (ARM) | :heavy_check_mark: | :heavy_check_mark: | HiPE            | :heavy_check_mark:  |
| Eclipse eMoflon dev      | macOS (ARM) |                    | :heavy_check_mark: | HiPE, *)        | :heavy_check_mark:  |
| Eclipse eMoflon dev HiPE | macOS (ARM) |                    | :heavy_check_mark: | *)              | :heavy_check_mark:  |
